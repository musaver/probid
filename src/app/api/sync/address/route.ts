...
// Inbound from OwnMidwest: update property physical address by mapId.
// Mirror of OwnMidwest's UpdatePropertyAddress.
...
export async function POST(req: Request) {
  ...
  try {
    ...
    if (typeof body.streetAddress === 'string') updates.address = body.streetAddress;
    ...
    console.error('[sync/address] error', err);
