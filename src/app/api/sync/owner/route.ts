// POST /api/sync/owner
// Inbound from OwnMidwest: update property owner info by mapId.
// Mirror of OwnMidwest's UpdatePropertyOwnerInfo.
...
export async function POST(req: Request) {
  ...
  try {
    ...
    if (fullName) updates.owners = [fullName];
    if (typeof body.street === 'string') updates.address = body.street;
