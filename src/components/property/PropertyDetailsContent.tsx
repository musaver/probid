                    ...
                    {activeTab === "documents" && (
                        <div className="documents-section">
                            <div className="documents-header">
                                ...
                                <p>View property documents (deeds, certificates, surveys, etc.)</p>
                            </div>
                            <div style={{ marginBottom: "12px", color: "#6B7280", fontSize: "13px" }}>
                                Documents can only be uploaded or deleted from the Edit Property page.
                            </div>
                            <PropertyDocumentsManager propertyId={id} readOnly={true} />
                        </div>
                    )}
                </div>
            </div>
