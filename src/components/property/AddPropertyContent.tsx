...
const AddPropertyContent = () => {
    ...
    useEffect(() => {
        // Float only once we reach `.dashboard-content` (trigger sentinel crosses the 140px top offset)
        ...
        const obs = new IntersectionObserver(
            (entries) => {
                ...
                // When the sentinel is no longer intersecting the viewport (with -140px top margin),
                // we've scrolled past `.dashboard-content` start → float the bar.
                                            ...
                                            <div className="form-section" style={{ marginTop: '25px' }}>
                                                ...
                                                <div className="form-row">
                                                    <div className="form-group" style={{ position: 'relative' }}>
                                                                ...
                                                                {bidderResults
                                                                    ...
                                                                    .map((bidder) => (
                                                                        <div
                                                                            key={bidder.id}
                                                                            onClick={() => {
                                                                                handleSelectBidder(bidder.id, bidder);
                                                                                setBidderQuery(""); // Clear search on selection
                                                                                setBidderResults([]);
                                                                            }}
                                                                            style={{
                                                                                padding: '10px',
                                                        ...
                                                        {/* Selected Bidders List */}
                                                        {selectedBidderIds.length > 0 && (
                                                            <div className="selected-bidders-list" style={{ marginTop: '10px' }}>
                                                                {selectedBidderIds.map((id) => {
