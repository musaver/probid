  ...
  const auditLogs = [
    {
      ...
      user: "Admin User",
      action: "Updated property P001"
    },
    {
      id: 2,
      timestamp: "2024-01-15 09:15 AM",
      user: "Admin User",
      action: "Added new bidder BD003"
    },
    {
      id: 3,
      timestamp: "2024-01-14 11:00 PM",
      user: "System",
      action: "Auction closed for property P005"
    },
    {
      id: 4,
      timestamp: "2024-01-14 03:45 PM",
      user: "Admin User",
      action: "Sent notification to all bidders"
    }
  ];
      ...
      <div className="dashboard-nav">
        <div className="container">
          <nav className="dashboard-menu">
            ...
            <Link href="/audit-log" className="nav-item active">
              <svg width="18" height="18" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M11.666 1.66406V4.9974C11.666 5.43942 11.8416 5.86335 12.1542 6.17591C12.4667 6.48847 12.8907 6.66406 13.3327 6.66406H16.666" stroke="currentColor" strokeWidth="1.66667" strokeLinecap="round" strokeLinejoin="round"/>
