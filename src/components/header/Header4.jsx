          ...
          <div className={`main-menu ${isMenuOpen ? "show-menu" : ""}`}>
            ...
            <li className="menu-item-has-children">
              ...
              >
                ...
                <li>
                  <Link href="/art-auction/dashboard">Dashboard</Link>
                </li>
                <li>
                  <Link href="/art-auction/add-property">Add Property</Link>
                </li>
                <li>
                  <Link href="/art-auction/property-details">Property Details</Link>
                </li>
                <li>
