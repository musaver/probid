            ...
            <div className={`main-menu ${isMenuOpen ? "show-menu" : ""}`}>
              ...
              <li className="menu-item-has-children">
                ...
                >
                  ...
                  <li>
                    <Link href="/antiques-auction/dashboard">Dashboard</Link>
                  </li>
                  <li>
                    <Link href="/antiques-auction/add-property">Add Property</Link>
                  </li>
                  <li>
                    <Link href="/antiques-auction/property-details">Property Details</Link>
                  </li>
                  <li>
