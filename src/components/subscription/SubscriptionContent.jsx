      ...
      <div className="dashboard-nav">
        <div className="container">
          <nav className="dashboard-menu">
            ...
            <Link href="/subscription" className="nav-item active">
            ...
            <div className="subscription-content">
              ...
              <div className="subscription-left">
                <div className="subscription-field">
                  <label className="subscription-label">Current Plan</label>
                  <div className="subscription-plan">Enterprise</div>
                </div>

                <div className="subscription-field">
                  <label className="subscription-label">Monthly Cost</label>
                  <div className="subscription-cost">$499/month</div>
                </div>

                <div className="subscription-buttons">
                  <button className="subscription-btn-primary">
                    Update Payment Method
                  </button>
                  <button className="subscription-btn-secondary">
              ...
              <div className="subscription-right">
                <div className="subscription-field">
                  <label className="subscription-label">Next Billing Date</label>
                  <div className="subscription-date">Feb 15, 2024</div>
                </div>
